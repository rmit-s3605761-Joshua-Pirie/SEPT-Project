...
public class UpcomingBookingsController {
    ...
    private void getBookings() {
        ...
        try {
            ...
            pstmt.setString(1, startDate.format(DateTimeFormatter.ISO_LOCAL_DATE));
            pstmt.setString(2, endDate.format(DateTimeFormatter.ISO_LOCAL_DATE));
        ...
        for(int y = 0; y < 20; y++) {
            for(int x = 0; x < 7; x++) {
                ...
                temp.setOnAction(e -> {
                    ...
                    showUpcomingBookingsList(data[0], data[1], newDate.format(DateTimeFormatter.ISO_LOCAL_DATE));
                });
    ...
    private void showUpcomingBookingsList(String day, String sTime, String date) {
        try {
            String fxml = "view/UpcomingBookingsList.fxml";
            String title = "Upcoming Booking List";
            UpcomingBookingsListController controller = CreateStage.newDialogStage(fxml,title).getController();
